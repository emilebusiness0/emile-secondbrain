...
8. **Backlink/directory campaign** — in progress, see [[duo-vert/backlink-campaign]]. Still open: fix wrong phone number on Facebook/Instagram (Yelp already fixed), follow up on HomeStars' postal-code signup bug, check back on Soumission Rénovation and Apple Business Connect submissions, work through the 8 remaining directories, and action the proposed English title/meta variants for pages ranking well on English queries but getting zero clicks.
